            ...
            <div class="box-body">
                ...
                <form method="POST" id="frmActualizarPerfil"
                    ...
                    <div class="form-group grupo-password">
                        ...
                        <span clas="help-block" id="spnMensajeContrasenaNoCoincide"><i class="fa fa-times-circle-o"></i>Las contraseñas no coinciden</span>
                    </div>
                    <div class="form-group">
                        <label>Foto</label>
...
<script>
    function doClickActualizar(event) {
        if($("#txtContrasena").val() == $("#tctConfirmarContrasena").val()) {
        //Envio el formulario
        $("#frmActualizarPerfil").submit();
        } else {
        //Muestra errores
        $("#spnMensajeContraseñaNoCoincide").show();
        $(".grupo-password").addClass('has-error');
        }
    }
    $(function(){
        $("#spnMensajeContrasenaNoCoincide").hide();
        $("#btnActualizar").click(doClickActulizar);
    });
</script>
@endsection